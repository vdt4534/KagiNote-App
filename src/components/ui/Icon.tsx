...
const icons = {
  ...
  'alert-triangle': (props: React.SVGProps<SVGSVGElement>) => (
    <svg fill="none" stroke="currentColor" strokeWidth={2} {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
    </svg>
  ),
  ...
  brain: (props: React.SVGProps<SVGSVGElement>) => (
    <svg fill="none" stroke="currentColor" strokeWidth={2} {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.5 2A2.5 2.5 0 0012 4.5v15a2.5 2.5 0 01-5 0V6.5a2.5 2.5 0 00-5 0v13A2.5 2.5 0 004.5 22a2.5 2.5 0 002.5-2.5V6.5a2.5 2.5 0 015 0v13a2.5 2.5 0 002.5 2.5 2.5 2.5 0 002.5-2.5V4.5A2.5 2.5 0 0014.5 2z" />
    </svg>
  ),
  
  'volume-x': (props: React.SVGProps<SVGSVGElement>) => (
    <svg fill="none" stroke="currentColor" strokeWidth={2} {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M5.586 5.586A2 2 0 017 5h2l6-6v22l-6-6H7a2 2 0 01-2-2zM23 9l-6 6M17 9l6 6" />
    </svg>
  ),
  ...
  // Special
  'bars-3': (props: React.SVGProps<SVGSVGElement>) => (
    <svg fill="none" stroke="currentColor" strokeWidth={2} {...props}>
